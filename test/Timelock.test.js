...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.cake = await DoubleMoonCash.new({ from: alice });
    ...
    it('should also work with MoonMaster', async () => {
        ...
        this.chef = await MoonMaster.new(this.cake.address, this.syrup.address, dev, '1000', '0', '1', { from: alice });
