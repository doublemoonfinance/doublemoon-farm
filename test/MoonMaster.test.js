...
const MoonMaster = artifacts.require('MoonMaster');
const MockBEP20 = artifacts.require('libs/MockBEP20');

contract('MoonMaster', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MoonMaster.new(this.cake.address, this.syrup.address, dev, '1000', '100', '1', { from: minter });
    ...
    it('real case', async () => {
      this.lp4 = await MockBEP20.new('LPToken', 'LP1', '1000000', { from: dev });
      this.lp5 = await MockBEP20.new('LPToken', 'LP2', '1000000', { from: dev });
      this.lp6 = await MockBEP20.new('LPToken', 'LP3', '1000000', { from: dev });
      this.lp7 = await MockBEP20.new('LPToken', 'LP1', '1000000', { from: dev });
      this.lp8 = await MockBEP20.new('LPToken', 'LP2', '1000000', { from: dev });
      this.lp9 = await MockBEP20.new('LPToken', 'LP3', '1000000', { from: dev });
