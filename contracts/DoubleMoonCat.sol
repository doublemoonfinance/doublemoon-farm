...
contract DoubleMoonCat is BEP20("DoubleMoon Cat", "DMC") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "DMC::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "DMC::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "DMC::getPriorVotes: not yet determined"
        );
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DMCs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "DMC::_writeCheckpoint: block number exceeds 32 bits"
            );
